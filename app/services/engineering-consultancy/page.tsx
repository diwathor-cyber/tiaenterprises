export const metadata = {
  title: "Engineering Consultancy | TIA Enterprises",
  description:
    "Engineering consultancy and project advisory solutions for businesses and infrastructure projects.",
};
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <h1 className="mt-5 text-5xl font-black leading-tight text-slate-900">
              Practical Engineering & Project Guidance
            </h1>

            <p className="mt-8 text-lg leading-8 text-slate-600">
              Engineering consultancy solutions for construction,
              interiors, project planning and business infrastructure
              requirements.
            </p>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              Suitable for commercial projects, industries,
              businesses, offices and infrastructure development.
            </p>
