export const metadata = {
  title: "Factory Insurance | TIA Enterprises",
  description:
    "Factory Insurance solutions for industries, manufacturing units and warehouses.",
};

export default function FactoryInsurancePage() {
  return (
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <h1 className="mt-5 text-5xl font-black leading-tight text-slate-900">
              Industrial Risk Protection Solutions
            </h1>

            <p className="mt-8 text-lg leading-8 text-slate-600">
              Factory Insurance helps industries protect machinery,
              inventory, infrastructure and operations against
              unexpected financial risks.
            </p>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              Suitable for manufacturing units, warehouses,
              engineering industries, processing plants and
